      ...
      <div class="bg-white rounded-2xl shadow-md w-full p-6 min-h-full">
        ...
        <div class="flex justify-between items-center mb-6">
          <div>
            ...
            <h1 class="text-3xl font-bold text-gray-800">Dashboard Kehadiran Guru</h1>
            <p class="text-gray-500">Pantau kehadiran guru secara real-time</p>
          </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
          ...
          <div class="bg-white p-5 rounded-xl border border-gray-200 flex items-start justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-800">42 <span class="text-lg font-normal text-gray-400">/ 45 guru</span></p>
              <p class="text-sm text-green-500 flex items-center mt-1">
                <ArrowUp class="w-4 h-4 mr-1" />
                3.2% <span class="text-gray-400 ml-1">dari minggu lalu</span>
              </p>
            </div>
          ...
          <div class="bg-white p-5 rounded-xl border border-gray-200 flex items-start justify-between">
            <div>
              <p class="text-gray-500 text-sm">Guru Check-in</p>
              <p class="text-3xl font-bold text-gray-800">38 <span class="text-lg font-normal text-gray-400">/ 45 guru</span></p>
              <p class="text-sm text-green-500 flex items-center mt-1">
                <ArrowUp class="w-4 h-4 mr-1" />
                2.0% <span class="text-gray-400 ml-1">dari kemarin</span>
              </p>
            </div>
          ...
          <div class="bg-white p-5 rounded-xl border border-gray-200 flex items-start justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-800">3 <span class="text-lg font-normal text-gray-400">guru</span></p>
              <p class="text-sm text-red-500 flex items-center mt-1">
                <ArrowUp class="w-4 h-4 mr-1" />
                1.2% <span class="text-gray-400 ml-1">dari minggu lalu</span>
              </p>
            </div>
          ...
          <div class="bg-white p-5 rounded-xl border border-gray-200 flex items-start justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-gray-800">93.3%</p>
              <p class="text-sm text-green-500 flex items-center mt-1">
                <ArrowUp class="w-4 h-4 mr-1" />
                1.8% <span class="text-gray-400 ml-1">dari bulan lalu</span>
              </p>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <!-- Left Column: Trend Chart and Teacher List -->
          <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200">
                <div class="flex justify-between items-center mb-4">
                    <h2 class="font-bold text-lg text-gray-800">Daftar Kehadiran Guru</h2>
                    <div class="flex items-center space-x-2">
                        <div class="relative">
                            <Search class="w-5 h-5 text-gray-400 absolute top-1/2 left-3 -translate-y-1/2" />
                            <input type="text" placeholder="Cari guru..." class="border rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-green-500">
                        </div>
                ...
                <div class="overflow-x-auto">
                  <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                      <tr v-for="teacher in teachers" :key="teacher.name" class="bg-white border-b">
                          <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                            <div class="flex items-center">
                              <div class="w-10 h-10 rounded-full mr-3 flex items-center justify-center text-white font-bold" :class="teacher.avatarBg">
                                {{ teacher.initials }}
                              </div>
                              <div>
                          ...
                          <td class="px-6 py-4">{{ teacher.checkIn }}</td>
                          <td class="px-6 py-4">{{ teacher.checkOut }}</td>
                          <td class="px-6 py-4">
                            <span class="px-2 py-1 rounded-full text-xs font-medium" :class="teacher.statusColor">{{ teacher.status }}</span>
                          </td>
                          <td class="px-6 py-4">{{ teacher.note }}</td>
                          <td class="px-6 py-4">
                ...
                <div class="flex justify-between items-center mt-4">
                  <span class="text-sm text-gray-500">Menampilkan 1-6 dari 45 guru</span>
                  <div class="flex items-center space-x-1">
                    ...
                    <button class="px-4 py-2 text-sm rounded-md hover:bg-gray-100 text-gray-600">3</button>
              ...
              <apexchart type="donut" height="250" :options="donutChartOptions" :series="donutChartSeries"></apexchart>
               <div class="mt-4 space-y-2 text-sm">
                <div class="flex justify-between items-center">
                  ...
                  <span class="font-medium text-gray-700">42 <span class="text-gray-400">(93.3%)</span></span>
                </div>
                <div class="flex justify-between items-center">
                  <span class="flex items-center"><span class="w-3 h-3 rounded-full bg-orange-400 mr-2"></span>Izin</span>
                  <span class="font-medium text-gray-700">2 <span class="text-gray-400">(4.4%)</span></span>
                </div>
                 <div class="flex justify-between items-center">
                  <span class="flex items-center"><span class="w-3 h-3 rounded-full bg-red-500 mr-2"></span>Sakit</span>
                  <span class="font-medium text-gray-700">1 <span class="text-gray-400">(2.2%)</span></span>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-xl border border-gray-200">
              ...
              <div class="space-y-4">
                <div class="flex">
                  ...
                  <div>
                    <p class="text-sm text-gray-800"><span class="font-bold">Nurul Sari</span> melakukan check-in</p>
                    <p class="text-xs text-gray-500">Check-in pada pukul 07:10:05</p>
                 ...
                 <div class="flex">
                  ...
                  <div>
                    <p class="text-sm text-gray-800"><span class="font-bold">Dian Purnama</span> mengajukan izin</p>
                    <p class="text-xs text-gray-500">Izin tidak hadir karena acara keluarga</p>
                    <span class="text-xs text-gray-400">45 menit yang lalu</span>
                  </div>
                </div>
              </div>
            </div>
